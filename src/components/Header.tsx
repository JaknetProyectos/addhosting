          ...
          <nav className="hidden md:flex items-center space-x-1">
            ...
            <div className="relative p-6">
              <button
                ...
                disabled={isPending}
                className={`flex items-center gap-2 px-3 py-2 rounded-lg border ${isLangOpen
                  ...
                  <div className="p-2 space-y-1">
                    {languages.map((lang) => (
                      <button
                        ...
                        className={`w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-xs font-bold transition-colors ${locale === lang.code
                ...
                <div className="grid grid-cols-2 gap-2">
                  {languages.map((lang) => (
                    <button
                      key={lang.code}
                      onClick={() => switchLanguage(lang.code)}
                      className={`flex items-center justify-center gap-2 py-3 rounded-xl border font-bold text-sm transition-all ${locale === lang.code
